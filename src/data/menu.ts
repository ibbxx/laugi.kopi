...
export const menuData: MenuCategory[] = [
  ...
  },
  {
    ...
    name: 'Tea Series',
    items: [
      { id: 'ts-1', name: 'Peach Mint Tea', price: 22000, image: '/images/menu/peach-mint-tea.webp' },
      { id: 'ts-2', name: 'Lemon Tea', price: 18000, image: '/images/menu/lemon-tea.webp' },
      { id: 'ts-3', name: 'Lychee Tea', price: 22000, image: '/images/menu/lychee-tea.webp' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'am-2', name: 'Coffee Americano Strawberry', price: 24000, image: '/images/menu/coffee-americano-strawberry.webp' },
      { id: 'am-3', name: 'Coffee Americano Peach', price: 24000, image: '/images/menu/coffee-americano-peach.webp' },
  ...
  },
  {
    ...
    name: 'Milk Based',
    items: [
      { id: 'mb-1', name: 'Choco Banana', price: 25000, image: '/images/menu/choco-banana.webp' },
      { id: 'mb-2', name: 'Choco Caramel', price: 25000, image: '/images/menu/choco-caramel.webp' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'ma-3', name: 'Matcha Strawberry', price: 29000, image: '/images/menu/matcha-strawberry.webp' },
